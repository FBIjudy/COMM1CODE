...
attack <- c("V3042","V3085","V3086")
sex2 <- da38090.0003[attack]
sex2 <-attack %>% na.omit()
summary(sex2)
sex2$V3085
sex2$orientation <- ifelse(sex2$V3084 == "(4) Something else ", "Other",
                      ifelse(sex2$V3084 == "(5) I don't know the answer", "Other",
                             ifelse(sex2$V3084 == "(6) Refused", "Other",
                                    ifelse(sex2$V3084 == "(8) Residue", NA,
                                           ifelse(sex2$V3084 =="(2) Straight, that is, not lesbian or gay", "Straight",
                                                  ifelse(sex2$V3084 == "(1) Lesbian or gay " | sex2$V3084 == "(3) Bisexual", "LGBT",
                                                ifelse(sex2$V3085 == "(1) Male" & sex2$V3086 == "(2) Female", "LGBT",
                                                       ifelse(sex2$V3085 == "(1) Female" & sex2$V3086 == "(2) Male","LGBT",
                                                              ifelse(sex2$V3086 == "(3) Transgender","LGBT",NA)))))))))
